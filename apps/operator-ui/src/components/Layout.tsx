...
import { LayoutDashboard, MessageSquare, Settings, LogOut, Layers, Briefcase, CreditCard, Target, Play } from 'lucide-react';
        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="w-64 bg-white border-r flex flex-col">
                ...
                <nav className="flex-1 p-4">
                    ...
                    <Link to="/runs" className={navClass('/runs')}>
                    ...
                    <Link to="/analytics/brands" className={navClass('/analytics/brands')}>
                        <LayoutDashboard className="w-5 h-5 mr-3" />
                        Performance
                    </Link>
                    <Link to="/analytics/usage" className={navClass('/analytics/usage')}>
                        <CreditCard className="w-5 h-5 mr-3" />
                        Usage & Limits
                    </Link>

                    <div className="pt-4 pb-2 px-3 text-xs font-semibold text-gray-500 uppercase">Account</div>
